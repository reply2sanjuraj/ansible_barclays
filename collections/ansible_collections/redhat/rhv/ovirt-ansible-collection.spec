%global namespace redhat
%global collectionname rhv
...
Source0:	http://resources.ovirt.org/pub/src/ovirt-ansible-collection/ovirt-ansible-collection-2.1.0.tar.gz
