...
description:
    ...
    - This module was called C(ovirt_external_provider_facts) before Ansible 2.9, returning C(ansible_facts).
      Note that the M(redhat.rhv.ovirt_external_provider_info) module no longer returns C(ansible_facts)!
notes:
...
options:
    ...
    follow:
        ...
        elements: str
        aliases: ['follows']
extends_documentation_fragment: redhat.rhv.ovirt_info
'''
...
- redhat.rhv.ovirt_external_provider_info:
    type: os_image
    name: glance
  register: result
